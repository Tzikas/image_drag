...
//Not being used in my project but probably a better way
// from http://www.bennadel.com/blog/2597-preloading-images-in-angularjs-with-promises.htm

// Provide a utility class for preloading image objects.
angular.module('routerApp').factory(
	"preloader",
	function( $q, $rootScope ) {
		...
		Preloader.prototype = {
			...
			// Dtermine if the preloader has failed to load all of the images.
